    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-semibold text-zinc-900 dark:text-zinc-100 mb-2 font-serif">Welcome back</h1>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Sign in to continue reading</p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8">
          ...
          <div className="mt-6 text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <Link href="/auth/signup" className="font-medium text-zinc-900 dark:text-zinc-100 hover:underline decoration-zinc-400">
              Sign up
            </Link>
          </div>
        </div>
